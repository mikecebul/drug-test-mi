...
export interface Product {
  id: string;
  /**
   * Product name (e.g., "15-Panel Instant Drug Test")
   */
  title: string;
  /**
   * Type of drug test
   */
  testType: 'instant' | 'lab' | 'instant-confirmation' | 'lab-confirmation';
  /**
   * Panel type for tests (N/A for confirmations)
   */
  panelType?: ('11-panel' | '15-panel' | 'na') | null;
  /**
