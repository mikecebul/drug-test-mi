...
import { useExtractPdfQuery, useFetchPendingTestsQuery } from '@/views/DrugTestWizard/queries'
import { getRankedTestMatches, type DrugTest } from '@/views/DrugTestWizard/utils/testMatching'
  ...
  render: function Render({ form }) {
    ...
    const handleTestSelect = (test: DrugTest) => {
      ...
      if (test.testType !== '15-panel-instant' && test.testType !== '17-panel-instant')
        form.setFieldValue(
          'labScreenData.testType',
          test.testType as '11-panel-lab' | '11-panel-lab-no-etg' | '8-panel-lab' | '17-panel-sos-lab' | 'etg-lab',
        )
    }
