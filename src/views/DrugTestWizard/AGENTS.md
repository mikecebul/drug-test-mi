...
- UI descriptions are usually unnecessary because the UI should stand on its own; use one only when it adds essential meaning beyond the title, never to explain underlying system behavior.
