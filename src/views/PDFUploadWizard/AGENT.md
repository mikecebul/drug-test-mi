...
## Files to Know
- **Workflows**: `src/views/PDFUploadWizard/workflows/*/Workflow.tsx`
- **Shared validators**: `src/views/PDFUploadWizard/workflows/register-client-workflow/validators.ts`
- **Shared form opts**: `src/app/(frontend)/register/shared-form.ts` (used by admin + frontend)
- **Registration dialog**: `src/views/PDFUploadWizard/components/RegisterClientDialog.tsx`
