...
export function OldCollectLabWorkflow({ onBack }: CollectLabWorkflowProps) {
  ...
  return (
    <>
      <WizardHeader title="Collect Lab Specimen" description="Record specimen collection for laboratory testing" />
      ...
      >
        <div className="wizard-content mb-8 flex-1">
          {currentStep === 1 && (
            <VerifyClientFieldGroup form={form} fields="clientData" title="Select Client" workflow="collect-lab" />
          )}
                        ...
                        <div className="space-y-2 border-t pt-4">
                          ...
                          <div className="pl-6">
                            <div className="flex items-center gap-2">
                              <Badge
                                variant={
                                  formValues.collectionDetails.breathalyzerResult! > 0.0 ? 'destructive' : 'default'
                                }
                                className={
        ...
        <div className="flex justify-between">
          ...
          {!isLastStep ? (
            <Button type="button" onClick={handleNext} size="lg" className="text-lg" disabled={canSubmit}>
              Next
