...
export function InstantTestWorkflow({ onBack }: { onBack: () => void }) {
  ...
  const { currentStep, isFirstStep, isLastStep, handleNextStepOrSubmit, handleCancelOrBack, setCurrentStep } =
  ...
  const stepComponents: Record<number, React.ReactNode> = {
    ...
    3: <VerifyClientFieldGroup form={form} fields="clientData" title="Verify Client" workflow="15-panel-instant" />,
    4: (
