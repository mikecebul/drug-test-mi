    ...
    <>
      <div className={wizardWrapperStyles.header}>
        <WizardHeader
          ...
          description="Upload and process laboratory confirmation (LC-MS/MS) test results"
        />
      </div>
      ...
      >
        <div className="wizard-content mb-8 flex-1">
          {currentStep === 1 && (
            <UploadFieldGroup form={form} fields="uploadData" title="Upload Confirmation Report" description="" />
          )}
