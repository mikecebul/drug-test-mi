...
export function useConfirmFieldLogic(group: any) {
  ...
  const medications = formValues?.medicationsData as PdfUploadFormType['medicationsData']
  ...
  const previewQuery = useComputeTestResultPreviewQuery(
    ...
    medications, // Pass medications from form for unexpected negative detection
  )
