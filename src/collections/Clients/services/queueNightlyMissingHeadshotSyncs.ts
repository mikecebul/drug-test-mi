...
export async function queueNightlyMissingHeadshotSyncs(payload: QueueNightlyPayload): Promise<{
  ...
  while (hasNextPage) {
    ...
    for (const doc of batch.docs) {
      ...
      try {
        await queueRedwoodHeadshotSync(clientId, undefined, payload as Payload)
