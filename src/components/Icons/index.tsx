...
export const lucideIcons = [
  ...
  { component: CheckCircle2, label: 'Check Circle 2', value: 'CheckCircle2' },
  ...
  { component: FileCheck, label: 'File Check', value: 'FileCheck' },
  ...
  { component: Home, label: 'Home', value: 'Home' },
  ...
  { component: LayoutDashboard, label: 'Layout Dashboard', value: 'LayoutDashboard' },
  { component: Mail, label: 'Mail', value: 'Mail' },
  { component: MapPin, label: 'Map Pin', value: 'MapPin' },
  { component: MessageSquare, label: 'Message Square', value: 'MessageSquare' },
  ...
  { component: Pill, label: 'Pill', value: 'Pill' },
