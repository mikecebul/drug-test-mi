...
type SelectContentProps = SelectPrimitive.Popup.Props &
  Pick<
    ...
    "align" | "alignItemWithTrigger" | "alignOffset" | "collisionAvoidance" | "side" | "sideOffset"
  >
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn('sticky top-0 flex w-full cursor-default items-center justify-center py-1', className)}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn('sticky bottom-0 flex w-full cursor-default items-center justify-center py-1', className)}
      {...props}
    >
