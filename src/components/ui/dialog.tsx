...
const DialogDescriptionDiv = React.forwardRef<
  HTMLDivElement, // Change the ref type to HTMLDivElement
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description>
>(({ className, ...props }, ref) => (
...
DialogDescriptionDiv.displayName = DialogPrimitive.Description.displayName
