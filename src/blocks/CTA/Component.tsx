...
export function CTABlock({ title, description, links, nested = false }: CTABlockProps) {
  const content = (
    <div className="border-border bg-card mx-auto flex w-full max-w-5xl flex-col items-start gap-6 rounded-lg border p-6 shadow-sm sm:p-8 lg:flex-row lg:items-center lg:justify-between lg:gap-10 lg:p-10">
